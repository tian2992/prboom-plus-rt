...
state_t states[NUMSTATES] = {
  ...
  {SPR_SHT2,1,7,A_CockingShotgun,S_DSGUN4,0,0}, // S_DSGUN3
  {SPR_SHT2,2,7,A_CheckReload,S_DSGUN5,0,0},  // S_DSGUN4
  {SPR_SHT2,3,7,A_OpenShotgun2,S_DSGUN6,0,0}, // S_DSGUN5
  {SPR_SHT2,4,7,A_CockingShotgun,S_DSGUN7,0,0}, // S_DSGUN6
  {SPR_SHT2,5,7,A_LoadShotgun2,S_DSGUN8,0,0}, // S_DSGUN7
  {SPR_SHT2,6,6,A_CockingShotgun,S_DSGUN9,0,0}, // S_DSGUN8
...
#define OLDBFG_8FRAMES(x) OLDBFG_4FRAMES(x) OLDBFG_4FRAMES(x+4)
  ...
  {SPR_PLAY,0,4,A_Chase,S_EVILMARINE_RUN2,0,0}, // S_EVILMARINE_RUN1
  {SPR_PLAY,0,4,A_Chase,S_EVILMARINE_RUN3,0,0}, // S_EVILMARINE_RUN2
  {SPR_PLAY,1,4,A_Chase,S_EVILMARINE_RUN4,0,0}, // S_EVILMARINE_RUN3
  {SPR_PLAY,1,4,A_Chase,S_EVILMARINE_RUN5,0,0}, // S_EVILMARINE_RUN4
  {SPR_PLAY,2,4,A_Chase,S_EVILMARINE_RUN6,0,0}, // S_EVILMARINE_RUN5
  {SPR_PLAY,2,4,A_Chase,S_EVILMARINE_RUN7,0,0}, // S_EVILMARINE_RUN6
  {SPR_PLAY,3,4,A_Chase,S_EVILMARINE_RUN8,0,0}, // S_EVILMARINE_RUN7
  {SPR_PLAY,3,4,A_Chase,S_EVILMARINE_RUN1,0,0}, // S_EVILMARINE_RUN8
  {SPR_PLAY,4,0,A_EvilMarine_ChooseAttack,S_EVILMARINE_ATK1,0,0}, // S_EVILMARINE_CHOOSEATK
  {SPR_PLAY,4,15,A_FaceTarget,S_EVILMARINE_ATK2,0,0}, // S_EVILMARINE_ATK1
  {SPR_PLAY,32773,2,A_PlamaAttack,S_EVILMARINE_ATK3,0,0}, // S_EVILMARINE_ATK2
  {SPR_PLAY,4,2,A_FaceTarget,S_EVILMARINE_ATK4,0,0}, // S_EVILMARINE_ATK3
  {SPR_PLAY,32773,2,A_PlamaAttack,S_EVILMARINE_ATK5,0,0}, // S_EVILMARINE_ATK4
  {SPR_PLAY,4,2,A_FaceTarget,S_EVILMARINE_ATK6,0,0}, // S_EVILMARINE_ATK5
  {SPR_PLAY,32773,2,A_PlamaAttack,S_EVILMARINE_ATK7,0,0}, // S_EVILMARINE_ATK6
  {SPR_PLAY,4,2,A_FaceTarget,S_EVILMARINE_ATK8,0,0}, // S_EVILMARINE_ATK7
  {SPR_PLAY,32773,2,A_PlamaAttack,S_EVILMARINE_ATK9,0,0}, // S_EVILMARINE_ATK8
  ...
  {SPR_PLAY,32773,10,A_RocketAttack,S_EVILMARINE_ROCKETATK3,0,0}, // S_EVILMARINE_ROCKETATK2
  ...
  {SPR_PLAY,32773,55,A_BFGChargeUpSound,S_EVILMARINE_BFGATK3,0,0}, // S_EVILMARINE_BFGATK2
  {SPR_PLAY,32773,18,A_BFGAttack,S_EVILMARINE_BFGATK4,0,0}, // S_EVILMARINE_BFGATK3
  {SPR_PLAY,4,10,NULL,S_EVILMARINE_RUN1,0,0}, // S_EVILMARINE_BFGATK4
  {SPR_PLAY,6,4,NULL,S_EVILMARINE_PAIN2,0,0}, // S_EVILMARINE_PAIN
  {SPR_PLAY,6,4,A_Pain,S_EVILMARINE_RUN1,0,0},  // S_EVILMARINE_PAIN2
  {SPR_PLAY,7,7,NULL,S_EVILMARINE_DIE2,0,0},  // S_EVILMARINE_DIE1
  {SPR_PLAY,8,7,A_Scream,S_EVILMARINE_DIE3,0,0},  // S_EVILMARINE_DIE2
  {SPR_PLAY,9,7,A_Fall,S_EVILMARINE_DIE4,0,0},  // S_EVILMARINE_DIE3
  {SPR_PLAY,10,7,NULL,S_EVILMARINE_DIE5,0,0}, // S_EVILMARINE_DIE4
  {SPR_PLAY,11,7,NULL,S_EVILMARINE_DIE6,0,0}, // S_EVILMARINE_DIE5
  {SPR_PLAY,12,7,NULL,S_EVILMARINE_DIE7,0,0}, // S_EVILMARINE_DIE6
  {SPR_PLAY,13,-1,NULL,S_NULL,0,0}, // S_EVILMARINE_DIE7
  {SPR_PLAY,14,5,NULL,S_EVILMARINE_XDIE2,0,0},  // S_EVILMARINE_XDIE1
  {SPR_PLAY,15,5,A_XScream,S_EVILMARINE_XDIE3,0,0}, // S_EVILMARINE_XDIE2
  {SPR_PLAY,16,5,A_Fall,S_EVILMARINE_XDIE4,0,0},  // S_EVILMARINE_XDIE3
  {SPR_PLAY,17,5,NULL,S_EVILMARINE_XDIE5,0,0},  // S_EVILMARINE_XDIE4
  {SPR_PLAY,18,5,NULL,S_EVILMARINE_XDIE6,0,0},  // S_EVILMARINE_XDIE5
  {SPR_PLAY,19,5,NULL,S_EVILMARINE_XDIE7,0,0},  // S_EVILMARINE_XDIE6
  {SPR_PLAY,20,5,NULL,S_EVILMARINE_XDIE8,0,0},  // S_EVILMARINE_XDIE7
  {SPR_PLAY,21,5,NULL,S_EVILMARINE_XDIE9,0,0},  // S_EVILMARINE_XDIE8
  {SPR_PLAY,22,-1,NULL,S_NULL,0,0}, // S_EVILMARINE_XDIE9
  {SPR_PLAY,13,7,NULL,S_EVILMARINE_RAISE2,0,0}, // S_EVILMARINE_RAISE1
  {SPR_PLAY,12,7,NULL,S_EVILMARINE_RAISE3,0,0}, // S_EVILMARINE_RAISE2
  {SPR_PLAY,11,7,NULL,S_EVILMARINE_RAISE4,0,0},  // S_EVILMARINE_RAISE3
  {SPR_PLAY,10,7,NULL,S_EVILMARINE_RAISE5,0,0},  // S_EVILMARINE_RAISE4
  {SPR_PLAY,9,7,NULL,S_EVILMARINE_RAISE6,0,0},  // S_EVILMARINE_RAISE5
  {SPR_PLAY,8,7,NULL,S_EVILMARINE_RAISE7,0,0},  // S_EVILMARINE_RAISE6
  {SPR_PLAY,7,7,NULL,S_EVILMARINE_RUN1,0,0},  // S_EVILMARINE_RAISE7
};
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
  ...
  {   // MT_EVILMARINE
    ...
    S_EVILMARINE_DIE1,    // deathstate
    S_EVILMARINE_XDIE1,   // xdeathstate
    sfx_podth2,   // deathsound
    8,    // speed
    20*FRACUNIT,    // radius
    56*FRACUNIT,    // height
    ...
    S_EVILMARINE_RAISE1   // raisestate
  },
